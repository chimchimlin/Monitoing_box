    ...
    #registerRoutes() {
        ...
        for (const routeModule of this.#routes) {
            ...
            switch (method) {
                case 'GET': {
                    if (loginRequired) {
                        this.#app.get(path, this.#authenticateLogin(allowPermissions), this.#handleRouteExecution(execute));
                    }
                    else {
                ...
                case 'POST': {
                    if (loginRequired) {
                        this.#app.post(path, this.#authenticateLogin(allowPermissions), this.#handleRouteExecution(execute));
                    }
                    else {
                ...
                case 'PUT': {
                    if (loginRequired) {
                        this.#app.put(path, this.#authenticateLogin(allowPermissions), this.#handleRouteExecution(execute));
                    }
                    else {
                ...
                case 'DELETE': {
                    if (loginRequired) {
                        this.#app.delete(path, this.#authenticateLogin(allowPermissions), this.#handleRouteExecution(execute));
                    }
                    else {
